...
public class HexapedeEntity extends Animal {
    public HexapedeEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, ViperwolfEntity.class, 24.0F, 1.5, 1.5));
        this.goalSelector.addGoal(2, new BreedGoal(this, 1d));
        this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.of(Items.ACACIA_BOAT), false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.HEXAPEDE.get().create(serverLevel);
    }
